...
L'objectif de ce TP est d'implémenter les differentes surchages d'opérateurs
relatifs à la classe Dvector. Ces dernières sont implémentées au sein même 
de la classe Dvector. Il y a deux dossiers : un dossier src/ contenant le 
code source de la classe Dvector et des tests de cette classe; un dossier 
doc/ permettant de générer la documentation de la classe. Voici la liste des 
commandes utiles pour ce TP, à lancer à partir du répertoire TP2_ghorreso_garcia1 :
...
Cette commande exécute tous les tests sur la classe Dvector. Elle affiche
